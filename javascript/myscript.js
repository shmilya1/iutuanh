...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Nhịp tim của Anh đang đập rất nhanhh " + (thePercent+899);
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-body').innerHTML = 'Anh lên cơn nghiện em mất rồii<i class="fas fa-heart"></i> ';
